-- Fase 5 — correção: permite omitir p_expected_total_cents e p_items na
-- chamada RPC (Postgrest exige valor para todo parâmetro sem default).
-- create or replace preserva a assinatura (mesmos nomes/tipos), só adiciona
-- defaults — não precisa de drop function.
